...
isgrmlcd && HISTSIZE=50000  || HISTSIZE=5000000
isgrmlcd && SAVEHIST=10000000 || SAVEHIST=10000000 # useful for setopt append_history
...
PATH="/home/steffen/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/steffen/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/steffen/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/steffen/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/steffen/perl5"; export PERL_MM_OPT;
